...
export default class Lwc_Faq_Custom extends LightningElement {
  ...
  // }
    ...
    this.template
      .querySelector("lightning-accordion")
      .style.setProperty("--my-verticalpadding", this.verticalpadding);
    ...
    this.template
      .querySelector("lightning-accordion")
      .style.setProperty("--my-horizontalpadding", this.horizontalpadding);
    ...
    this.template
      .querySelector("lightning-accordion")
      .style.setProperty("--my-bottompadding", this.bottompadding);
    ...
    this.template
      .querySelector("lightning-accordion")
      .style.setProperty("--my-rightpadding", this.rightpadding);
